...
export function FloatingAssistantButton() {
  return (
    <Link href="/dashboard/assistant" className="fixed bottom-6 right-6 z-40 flex items-center gap-3">
      ...
      <span className="flex h-14 w-14 flex-shrink-0 items-center justify-center rounded-full bg-[var(--color-amber)] text-white shadow-lg transition hover:bg-[var(--color-amber-light)]">
